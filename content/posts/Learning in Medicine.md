...
We compare patients post-admission to their state pre-admission and see a definitive change. But the decisions that led there are often plagued by uncertainty. No amount of simulation or exams can eliminate the fact that medicine is often a carefully weighed coin toss taking inputs from experience, improvisation, and gut feeling. Both Daniel Kahneman (<a href="#citeproc_bib_item_1">2011</a>) and Groopman (<a href="#citeproc_bib_item_2">2007</a>) speak to terrifying complexities of thinking that makes up this job.

Added to this is the pressure of time. There is a brilliant analogy in How Doctors Think (<a href="#citeproc_bib_item_2">Groopman 2007</a>) that captures the cognitive load perfectly
...
## The Ontology of Expertise {#the-ontology-of-expertise}
...
## Learning as a Ritual {#learning-as-a-ritual}
...
<style>.csl-entry{text-indent: -1.5em; margin-left: 1.5em;}</style><div class="csl-bib-body">
  <div class="csl-entry"><a id="citeproc_bib_item_1"></a>Daniel Kahneman. 2011. <i>Thinking, Fast and Slow</i>. Penguin.</div>
  <div class="csl-entry"><a id="citeproc_bib_item_2"></a>Groopman, Jerome E. 2007. <i>How Doctors Think</i>. Houghton Mifflin Company.</div>
</div>

[^fn:1]: Clearly I know nothing about orthopaedics
